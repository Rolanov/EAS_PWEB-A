...
// $getdata = mysqli_query($koneksi,"SELECT * FROM pendaftar");
...
// $jumlahdata = mysqli_num_rows($queryInner);
?>
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="pengumuman.php" class="nav-item nav-link active">Pengumuman</a>
                    </div>
                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5 py-5">
                        <div class="col-12 text-center">
                            <h1 class="text-white animated zoomIn">Pengumuman</h1>
